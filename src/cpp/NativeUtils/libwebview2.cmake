...
if(WINXP)
  ...
  file(WRITE "${webview2_SOURCE_DIR}/WebView2EnvironmentOptions.h" "${WebView2EnvironmentOptions}")

  file(READ "${webview2_SOURCE_DIR}/WebView2.h" WebView2H)
  string(REPLACE [=[#include "EventToken.h"]=] "typedef struct EventRegistrationToken\n    {\n    __int64 value;\n    } 	EventRegistrationToken;" WebView2H "${WebView2H}")
  file(WRITE "${webview2_SOURCE_DIR}/WebView2.h" "${WebView2H}")
