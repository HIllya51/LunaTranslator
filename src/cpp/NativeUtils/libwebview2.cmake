...
if(WINXP)
  file(READ "${webview2_SOURCE_DIR}/build/native/include/WebView2EnvironmentOptions.h" WebView2EnvironmentOptions)
  ...
  file(WRITE "${webview2_SOURCE_DIR}/build/native/include/WebView2EnvironmentOptions.h" "${WebView2EnvironmentOptions}")
endif()