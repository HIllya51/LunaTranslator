...
void CharFilter(TextBuffer *buffer, char ch) { CharFilter_impl((char *)buffer->buff, &buffer->size, ch); }
void CharFilter(TextBuffer *buffer, wchar_t ch) { CharFilter_impl((wchar_t *)buffer->buff, &buffer->size, ch); }

void CharsFilter(TextBuffer *buffer, const char *chars) { CharsFilter_impl((char *)buffer->buff, &buffer->size, chars); }
void CharsFilter(TextBuffer *buffer, const wchar_t *chars) { CharsFilter_impl((wchar_t *)buffer->buff, &buffer->size, chars); }

void StringFilter(TextBuffer *buffer, const char *remove, size_t removelen) { StringFilter_impl((char *)buffer->buff, &buffer->size, remove, removelen); }
void StringFilter(TextBuffer *buffer, const wchar_t *remove, size_t removelen) { StringFilter_impl((wchar_t *)buffer->buff, &buffer->size, remove, removelen); }

void StringFilterBetween(TextBuffer *buffer, const char *fr, size_t frlen, const char *to, size_t tolen) { StringFilterBetween_impl((char *)buffer->buff, &buffer->size, fr, frlen, to, tolen); }
void StringFilterBetween(TextBuffer *buffer, const wchar_t *fr, size_t frlen, const wchar_t *to, size_t tolen)
{
  StringFilterBetween_impl((wchar_t *)buffer->buff, &buffer->size, fr, frlen, to, tolen);
}

void StringCharReplacer(TextBuffer *buffer, const char *src, size_t srclen, char ch) { StringCharReplacer_impl((char *)buffer->buff, &buffer->size, src, srclen, ch); }
void StringCharReplacer(TextBuffer *buffer, const wchar_t *src, size_t srclen, wchar_t ch) { StringCharReplacer_impl((wchar_t *)buffer->buff, &buffer->size, src, srclen, ch); }

void StringReplacer(TextBuffer *buffer, const char *src, size_t srclen, const char *dst, size_t dstlen) { StringReplacer_impl((char *)buffer->buff, &buffer->size, src, srclen, dst, dstlen); }
void StringReplacer(TextBuffer *buffer, const wchar_t *src, size_t srclen, const wchar_t *dst, size_t dstlen) { StringReplacer_impl((wchar_t *)buffer->buff, &buffer->size, src, srclen, dst, dstlen); }
