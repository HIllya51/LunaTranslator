#ifndef CPPCSTRING_H_9A0E9FC7_85EF_4EF8_ABFD_CEFB6017BDED
#define CPPCSTRING_H_9A0E9FC7_85EF_4EF8_ABFD_CEFB6017BDED
...
template <typename charT>
inline charT *cpp_basic_strnchr(charT *s, charT c, size_t n) cpp_basic_strnchr_(s, c, n) template <typename charT>
inline const charT *cpp_basic_strnchr(const charT *s, charT c, size_t n) cpp_basic_strnchr_(s, c, n)

    // The same as memchr
    inline char *cpp_strnchr(char *s, char c, size_t n)
{
  return cpp_basic_strnchr<char>(s, c, n);
}
    ...
    cpp_basic_strnpbrk_(dest, breakset, n)
        ...
        inline const charT *cpp_basic_strnpbrk(const charT *dest, const char2T *breakset, size_t n)
            cpp_basic_strnpbrk_(dest, breakset, n)
                ...
                inline char *cpp_strnpbrk(char *dest, const char *breakset, size_t n)
{
  return cpp_basic_strnpbrk(dest, breakset, n);
}
