...
defaultglobalconfig = {'position': [432, 613], 'fixedheight': False, 'width': 768.8, 'autorun': True, 'transparent': 82, 'fontsize': 17.699999999999996, 'fonttype': '思源黑体 CN Medium', 'issolid': False, 'iskongxin': True, 'isshowrawtext': True, 'rawtextcolor': '#000000', 'backcolor': '#7a8b8a', 'isshowhira': False, 'locktools': True, 'showfanyisource': True, 'autoread': False, 'extractalltext': False, 'reader': {'azuretts':{'use':False,'voice':''}, 'huoshantts':{'use':False,'voice':''}, 'windowstts': {'use':False,'voice':''}}, 'LocaleEmulator': '', 'verticalocr': False, 'outputtopasteboard': False, 'ttscommon': { 'rate': 1.0, 'volume': 100.0},
 ...
 'fanyi': {
    ...
    #  'google2': {'use': False, 'color': '#95a5ff', 'name': '谷歌2'},
      'sougou': {
    'use': False, 'color': '#0ff000', 'name': '搜狗'}, 'caiyun': {'use': False, 'color': '#0ff000', 'name': '彩云'},'deepl': {'use': False, 'color': '#0ff000', 'name': 'deepl'}, 'jb7': {'use': True, 'color': '#1839f0', 'name': 'Jbeijing7', 'argsfile': './userconfig/jbj7.json'}, 'kingsoft': {'use': True, 'color': '#1839f0', 'name': '金山快译', 'argsfile': './userconfig/ks.json'}, 'dreye': {'use': True, 'color': '#1839f0', 'name': '快译通', 'argsfile': './userconfig/dreye.json'}, 'sougou2': {'use': False, 'color': '#0ff000', 'name': '搜狗2'}, 'youdao3': {'use': False, 'color': '#0ff000', 'name': '有道3'}, 'youdao4': {'use': False, 'color': '#0ff000', 'name': '有道4'}, 'youdao5': {'use': False, 'color': '#0ff000', 'name': '有道5'},   'tencent': {'use': False, 'color': '#0ff000', 'name': 'TX'},
...
defaultpost = {'_1': {'use': True, 'name': '去除花括号{}'}, '_2': {'use': True, 'name': '去除重复字符(若为1则自动分析去重)', 'args': {'重复次数': 1}}, '_3': {'use': True, 'name': '去除重复行'}, '_4': {
    'use': True, 'name': '过滤HTML标签'}, '_6': {'use': True, 'name': '过滤换行符'},'_9': {'use': True, 'name': '过滤数字和英文字母'}, '_7': {'use': True, 'name': '简单替换内容(若替换为空则直接过滤)', 'args': {'替换内容': {}}},'_8': {'use': True, 'name': '使用正则表达式替换', 'args': {'替换内容': {}}}}
