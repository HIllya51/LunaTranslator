...
class TS(basetrans):
    ...
    def inittranslator(self)  :  
        ...
        html=self.ss.get('https://translate.google.com/',headers = {
            ...
            },  timeout = globalconfig['translatortimeout']).text
        #print(html)
    ...
    def realfy1(self,content): 
        ...
        try:
            response =self.ss.post('https://translate.google.com/_/TranslateWebserverUi/data/batchexecute', headers=headers,timeout = globalconfig['translatortimeout'],  data=freq, proxies= globalconfig['proxies'] if globalconfig['proxies'] else {'http': None,'https': None})
