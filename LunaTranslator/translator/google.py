...
class TS(basetrans):
    ...
    def inittranslator(self)  :  
        ...
        }, verify=False, timeout = globalconfig['translatortimeout']).text 
        #print(html)
    ...
    def realfy1(self,content): 
        ...
        response = self.ss.post('https://translate.google.com/_/TranslateWebserverUi/data/batchexecute',verify=False, headers=headers,timeout = globalconfig['translatortimeout'],  data=freq )
