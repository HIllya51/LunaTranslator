...
class TS(basetrans):
    ...
    def realfy1(self,content): 
        ...
        try:
            response =self.ss.post('https://translate.google.com/_/TranslateWebserverUi/data/batchexecute', headers=headers,timeout = globalconfig['translatortimeout'],  data=freq, proxies=  {'http': None,'https': None})
