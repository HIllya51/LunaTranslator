language_list_show=["简体中文","繁體中文","English","Русский язык","Français","Español","한국어"]
language_list=["chs","cht","en","ru","fr","es","ko"]
...
language_list_translator=["简体中文","日文","英文","俄语","西班牙语","韩语","法语","繁体中文"]
language_list_translator_inner=["zh", "ja", "en","ru","es","ko","fr","cht"]
