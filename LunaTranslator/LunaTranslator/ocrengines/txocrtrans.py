...
import hashlib
import requests,time,random,hmac,base64,uuid,json
...
class OCR(baseocr):
    ...
    def ocr(self,imgfile): 
        ...
        region = ["ap-beijing","ap-shanghai","ap-chengdu","ap-chongqing","ap-guangzhou","ap-hongkong","ap-mumbai","ap-seoul","ap-shanghai-fsi","ap-shenzhen-fsi","ap-singapore","ap-tokyo","ap-bangkok","eu-frankfurt","na-ashburn","na-siliconvalley","na-toronto"][self.config['Region']];
        version = '2018-03-21';
        ...
        try:
            boxs=[(_['X'],_['Y'],_['X']+_['W'],_['Y']+_['H']) for _ in r.json()['Response']['ImageRecord']['Value']]
            texts=[_['TargetText'] for _ in r.json()['Response']['ImageRecord']['Value']]
