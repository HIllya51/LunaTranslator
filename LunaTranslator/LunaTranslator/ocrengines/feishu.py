...
class OCR(baseocr):
    ...
    def ocr(self,imgfile):  
        ...
        res=requests.post('https://open.feishu.cn/open-apis/optical_char_recognition/v1/image/basic_recognize', proxies= self.proxy,headers={'Content-Type':"application/json; charset=utf-8",'Authorization':'Bearer '+token},json={
