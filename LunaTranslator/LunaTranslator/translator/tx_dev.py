...
class TS(basetransdev): 
    ...
    def translate(self,content):  
        ...
        if self.tgtlang in tgtlist:
            ...
            tgtidx=1
        self.Runtime_evaluate('''document.querySelector('div.textpanel-tool.tool-close').click();
        ...
        return self.wait_for_result("document.getElementsByClassName('textpanel-target-textblock')[0].innerText") 