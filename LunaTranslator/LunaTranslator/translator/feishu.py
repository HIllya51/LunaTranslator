...
class TS(basetrans):  
    ...
    def translate(self,query):   
        ...
        token=self.check()
        res=self.session.post('https://open.feishu.cn/open-apis/translation/v1/text/translate',  headers={'Content-Type':"application/json; charset=utf-8",'Authorization':'Bearer '+token},json={
