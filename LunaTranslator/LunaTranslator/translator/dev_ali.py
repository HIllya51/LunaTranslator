...
class TS(basetransdev):  
    ...
    def translate(self,content):   
        ...
        self.Runtime_evaluate('i=document.querySelector("#source");i.value=``;event = new Event("input", {{bubbles: true, cancelable: true }});i.dispatchEvent(event);i.value=`{}`;event = new Event("input", {{bubbles: true, cancelable: true }});i.dispatchEvent(event);'.format(content))
