...
class TS(basetransdev): 
    ...
    def translate(self,content):  
        self.Runtime_evaluate('''document.getElementById('tta_clear').click();document.getElementById('tta_input_ta').value=`{}`;
            document.getElementById('tta_input_ta').click();
            '''.format(content))
        return self.wait_for_result("document.getElementById('tta_output_ta').value",' ...') 