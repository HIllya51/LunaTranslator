...
class TS(basetrans): 
    ...
    def inittranslator(self):  
        ...
        self.session.get('https://translate.alibaba.com',headers = { 
        ...
        self.csrf=self.session.get('https://translate.alibaba.com/api/translate/csrftoken').json()['token']
    ...
    def translate(self, content):
        ...
        r = self.session.post('https://translate.alibaba.com/api/translate/text', headers= headers, params =form_data )
