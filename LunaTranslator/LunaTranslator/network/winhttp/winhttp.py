...
from ctypes import windll,POINTER,pointer,create_string_buffer,create_unicode_buffer,Structure,sizeof
...
WinHttpOpenRequest.argtypes=HINTERNET,LPCWSTR,LPCWSTR,LPCWSTR,LPCWSTR,POINTER(LPCWSTR),DWORD
...
try:
    ...
    WinHttpWebSocketCompleteUpgrade=WinHttpWebSocketSend=WinHttpWebSocketReceive=WinHttpWebSocketClose=_undefined
