...
def setTabThree(self) :
        ...
        self.font_type_combo.addItems(['普通字体','空心字体','描边字体','阴影字体'])
        ...
        self.customSetGeometry(self.miaobian_color_button, 600, 170, 20, 20)
        ...
        self.customSetGeometry(s, 600, 140,50, 20) 
