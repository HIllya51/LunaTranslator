...
1. #### 原文を表示/非表示 {#anchor-_5}
    原文を表示するかどうかを切り替えます。すぐに反映されます。

1. #### 翻訳を表示/非表示 {#anchor-_51}
...
1. #### 読み上げを中断 {#anchor-_7_1}
    読み上げを中断します。

## ゲーム

1. #### ウィンドウをバインド（クリックしてキャンセル） {#anchor-_15}
