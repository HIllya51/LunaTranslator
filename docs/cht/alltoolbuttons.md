...
1. #### <i class="fa fa-gear"></i> <i class="fa fa-icon fa-rotate-right"></i> 打開設置 {#anchor-setting}
    略
1. #### <i class="fa fa-file"></i> <i class="fa fa-icon fa-rotate-right"></i> 讀取剪貼板 {#anchor-copy_once}
    這個的實際意義是，不管當前的默認文本輸入源是什麼，都從剪貼板讀取一次文本，並傳給之後的翻譯/tts/...流程

    右擊按鈕會追加讀取到的文本到當前文本之後。
1. #### <i class="fa fa-futbol"></i> <i class="fa fa-icon fa-rotate-right"></i> 遊戲設置 {#anchor-open_game_setting}
    當使用HOOK模式連接到遊戲，或使用OCR模式綁定遊戲窗口後，則可以通過這個按鈕直接打開當前遊戲的設置窗口
1. #### <i class="fa fa-mouse-pointer"></i> <i class="btnstatus2 fa fa-mouse-pointer"></i> 鼠標穿透窗口 {#anchor-mousetransbutton}
...
1. #### <i class="fa fa-lock"></i> <i class="btnstatus2 fa fa-unlock"></i> 鎖定工具欄 {#anchor-locktoolsbutton}
    激活後工具欄將始終顯示。
...
1. #### <i class="fa fa-tasks"></i> <i class="fa fa-icon fa-rotate-right"></i> 選擇文本 {#anchor-selecttext}
    **該按鈕僅在HOOK模式下可用**

    點擊按鈕彈出選擇遊戲文本窗口，來選擇要翻譯哪條HOOK到的文本。

    不過，選擇文本窗口在選擇進程後會自動彈出，這個按鈕實際上是用來更換選擇的文本，或修改一些設置用的。
1. #### <i class="fa fa-crop"></i> <i class="fa fa-icon fa-rotate-right"></i> 選取OCR範圍 {#anchor-selectocrrange}
    **該按鈕僅在OCR模式下可用**
...
1. #### <i class="fa fa-square"></i> <i class="fa fa-icon fa-rotate-right"></i> 顯示/隱藏範圍框 {#anchor-hideocrrange}
    **該按鈕僅在OCR模式下可用**
    ...
    當按下右鍵時，會清除所有已選取範圍
1. #### <i class="fa fa-crop"></i> <i class="fa fa-icon fa-rotate-right"></i> 進行一次OCR {#anchor-ocr_once}
...
1. #### <i class="fa fa-spinner"></i> <i class="fa fa-icon fa-rotate-right"></i> 再次進行OCR {#anchor-ocr_once_follow}
    當使用過一次`進行一次OCR`後，使用這個按鈕，可以在原來的位置上再次進行一次OCR而無需重新選擇識別區域。
    
1. #### <i class="fa fa-book"></i> <i class="fa fa-icon fa-rotate-right"></i> 專有名詞翻譯_直接替換 {#anchor-noundict_direct}
...
1. #### <i class="fa fa-won"></i> <i class="fa fa-icon fa-rotate-right"></i> 翻譯結果修正 {#anchor-fix}
    ...
    鼠標右鍵點擊時，必然打開全局的詞典設置。
1. #### <i class="fa fa-minus"></i> <i class="fa fa-icon fa-rotate-right"></i> 最小化到托盤 {#anchor-minmize}
    略
...
1. #### <i class="fa fa-compress"></i> <i class="fa fa-expand"></i> 窗口縮放 {#anchor-fullscreen}
    可以一鍵對遊戲窗口使用內置的Magpie進行縮放。

    左鍵爲窗口化縮放，右鍵爲全屏縮放。

1. #### <i class="fa fa-camera"></i> <i class="fa fa-icon fa-rotate-right"></i> 窗口截圖 {#anchor-grabwindow}
...
1. #### <i class="fa fa-copy"></i> <i class="fa fa-icon fa-rotate-right"></i> 複製到剪貼板 {#anchor-copy}
    複製當前提取到的文本到剪貼板一次。如果想要自動提取到剪貼板，應當激活`文本輸入`->`剪貼板`->`自動輸出`->`自動輸出文本`。
1. #### <i class="fa fa-rotate-left"></i> <i class="fa fa-icon fa-rotate-right"></i> 顯示/隱藏曆史文本 {#anchor-history}
    打開或關閉歷史文本的窗口。
...
1. #### <i class="fa fa-edit"></i> <i class="fa fa-icon fa-rotate-right"></i> 編輯_翻譯記錄 {#anchor-edittrans}
    打開當前遊戲的翻譯記錄編輯窗口
1. #### <i class="fa fa-download"></i> <i class="fa fa-icon fa-rotate-right"></i> 模擬按鍵Ctrl {#anchor-simulate_key_ctrl}
1. #### <i class="fa fa-download"></i> <i class="fa fa-icon fa-rotate-right"></i> 模擬按鍵Enter {#anchor-simulate_key_enter}
...
1. #### <i class="fab fa-windows"></i> <i class="btnstatus2 fab fa-windows"></i> 綁定窗口（部分軟件不支持）（點擊自己取消） {#anchor-bindwindow}
...
1. #### <i class="fa fa-neuter"></i> <i class="btnstatus2 fa fa-neuter"></i> 窗口置頂 {#anchor-keepontop}
    取消/置頂翻譯窗口
