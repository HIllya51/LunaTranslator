...
1. #### Lọc các ký tự ngoài bộ chữ tiếng Nhật {#anchor-_remove_non_shiftjis_char}
...
1. #### Lọc các ký tự ngoài ngoặc 「」 {#anchor-_remove_not_in_ja_bracket}

    Ví dụ: `こなみ「ひとめぼれってやつだよね……」` sẽ được xử lý thành `「ひとめぼれってやつだよね……」`

1. #### Lọc dấu ngoặc nhọn {} {#anchor-_1}
...
1. #### Chuẩn hóa Unicode {#anchor-fulltohalf}

    Xem chi tiết tại: [https://vi.wikipedia.org/wiki/Unicode_equivalence](https://en.wikipedia.org/wiki/Unicode_equivalence)

    Ví dụ: `？？？（Ｉ ｇｕｅｓｓ ｈｅ ｄｏｅｓｎ’ｔ ｗａｎｔ ｔｏ ｔａｌｋ ｔｏ ｓｔｒａｎｇｅｒｓ．．．）` sẽ được chuyển đổi thành: `???(I guess he doesn’t want to talk to strangers...)`

1. #### Trích xuất số lượng dòng cụ thể {#anchor-lines_threshold_1}
...
1. #### HOOK Xóa ký tự trùng lặp AAAABBBBCCCC->ABC {#anchor-_2}
...
1. #### HOOK Lọc các dòng trùng lặp ABCDABCDABCD->ABCD {#anchor-_3}
...
1. #### HOOK Lọc các dòng trùng lặp S1S1S1S2S2S2->S1S2 {#anchor-_3_2}
...
1. #### HOOK Lọc các dòng trùng lặp ABCDBCDCDD->ABCD {#anchor-_10}
...
1. #### HOOK Lọc các dòng trùng lặp AABABCABCD->ABCD {#anchor-_13EX}
...
1. #### Lọc dấu ngắt dòng {#anchor-_6EX}
