...
1. #### <i class="fa fa-gear"></i> <i class="fa fa-icon fa-rotate-right"></i> Mở Cài đặt {#anchor-setting}
    N/A
1. #### <i class="fa fa-file"></i> <i class="fa fa-icon fa-rotate-right"></i> Đọc Clipboard {#anchor-copy_once}
...
1. #### <i class="fa fa-mouse-pointer"></i> <i class="btnstatus2 fa fa-mouse-pointer"></i> Cửa sổ xuyên chuột {#anchor-mousetransbutton}
...
1. #### <i class="fa fa-lightbulb"></i> <i class="btnstatus2 fa fa-lightbulb"></i> Độ trong suốt của cửa sổ nền {#anchor-backtransbutton}
...
1. #### <i class="fa fa-crop"></i> <i class="fa fa-icon fa-rotate-right"></i> Chọn phạm vi OCR {#anchor-selectocrrange}
...
1. #### <i class="fa fa-crop"></i> <i class="fa fa-icon fa-rotate-right"></i> Thực hiện OCR một lần {#anchor-ocr_once}
...
1. #### <i class="fa fa-spinner"></i> <i class="fa fa-icon fa-rotate-right"></i> Thực hiện OCR lại {#anchor-ocr_once_follow}
...
1. #### <i class="fa fa-book"></i> <i class="fa fa-icon fa-rotate-right"></i> Dịch danh từ riêng_Thay thế trực tiếp {#anchor-noundict_direct}
1. #### <i class="fa fa-book"></i> <i class="fa fa-icon fa-rotate-right"></i> Dịch danh từ riêng {#anchor-noundict}
...
1. #### <i class="fa fa-minus"></i> <i class="fa fa-icon fa-rotate-right"></i> Thu nhỏ vào khay hệ thống {#anchor-minmize}
    N/A
...
1. #### <i class="fa fa-compress"></i> <i class="fa fa-expand"></i> Tỷ lệ cửa sổ {#anchor-fullscreen}
...
1. #### <i class="fa fa-camera"></i> <i class="fa fa-icon fa-rotate-right"></i> Chụp màn hình cửa sổ {#anchor-grabwindow}
...
1. #### <i class="fa fa-toggle-on"></i> <i class="btnstatus2 fa fa-toggle-off"></i> Hiển thị/Ẩn dịch thuật {#anchor-showtrans}
...
1. #### <i class="fa fa-copy"></i> <i class="fa fa-icon fa-rotate-right"></i> Sao chép vào clipboard {#anchor-copy}
...
1. #### <i class="fa fa-edit"></i> <i class="fa fa-icon fa-rotate-right"></i> Chỉnh sửa_Lịch sử dịch thuật {#anchor-edittrans}
    Mở cửa sổ chỉnh sửa lịch sử dịch thuật cho trò chơi hiện tại.
1. #### <i class="fa fa-download"></i> <i class="fa fa-icon fa-rotate-right"></i> Mô phỏng nhấn phím Ctrl {#anchor-simulate_key_ctrl}
1. #### <i class="fa fa-download"></i> <i class="fa fa-icon fa-rotate-right"></i> Mô phỏng nhấn phím Enter {#anchor-simulate_key_enter}
...
1. #### <i class="fa fa-list-ul"></i> <i class="fa fa-icon fa-rotate-right"></i> Ghi chú {#anchor-memory}
...
1. #### <i class="fab fa-windows"></i> <i class="btnstatus2 fab fa-windows"></i> Liên kết cửa sổ (Một số phần mềm không hỗ trợ) (Nhấp để hủy) {#anchor-bindwindow}
...
1. #### <i class="fa fa-neuter"></i> <i class="btnstatus2 fa fa-neuter"></i> Luôn ở trên cùng {#anchor-keepontop}
    Hủy bỏ/Luôn ở trên cùng cửa sổ dịch

1. #### <i class="fa fa-i-cursor"></i> <i class="btnstatus2 fa fa-i-cursor"></i> Có thể chọn {#anchor-selectable}
...
1. #### <i class="fa fa-search"></i> <i class="fa fa-icon fa-rotate-right"></i> Tra cứu {#anchor-searchwordW}
