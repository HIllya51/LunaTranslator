...
1. #### <i class="fa fa-rotate-right"></i> <i class="fa fa-icon fa-rotate-right"></i> Thực thi thủ công {#anchor-retrans}
...
1. #### <i class="fa fa-gear"></i> <i class="fa fa-icon fa-rotate-right"></i> Mở cài đặt {#anchor-setting}
    N/A
1. #### <i class="fa fa-file"></i> <i class="fa fa-icon fa-rotate-right"></i> Đọc khay nhớ tạm {#anchor-copy_once}
...
1. #### <i class="fa fa-mouse-pointer"></i> <i class="btnstatus2 fa fa-mouse-pointer"></i> Chuột xuyên thấu (Click-through) {#anchor-mousetransbutton}
...
1. #### <i class="fa fa-crop"></i> <i class="fa fa-icon fa-rotate-right"></i> Chọn vùng OCR {#anchor-selectocrrange}
...
1. #### <i class="fa fa-square"></i> <i class="fa fa-icon fa-rotate-right"></i> Hiện/Ẩn khung vùng chọn {#anchor-hideocrrange}
    **Nút này chỉ có sẵn trong chế độ OCR**
...
1. #### <i class="fa fa-spinner"></i> <i class="fa fa-icon fa-rotate-right"></i> Thực hiện OCR lần nữa {#anchor-ocr_once_follow}
...
1. #### <i class="fa fa-book"></i> <i class="fa fa-icon fa-rotate-right"></i> Thay thế trước khi dịch {#anchor-noundict_direct}
1. #### <i class="fa fa-book"></i> <i class="fa fa-icon fa-rotate-right"></i> Dịch danh từ riêng {#anchor-noundict}
1. #### <i class="fa fa-won"></i> <i class="fa fa-icon fa-rotate-right"></i> Chỉnh sửa kết quả dịch {#anchor-fix}
...
1. #### <i class="fa fa-minus"></i> <i class="fa fa-icon fa-rotate-right"></i> Thu nhỏ xuống khay hệ thống {#anchor-minmize}
    N/A
...
1. #### <i class="fa fa-eye"></i> <i class="btnstatus2 fa fa-eye-slash"></i> Hiện/Ẩn bản gốc {#anchor-showraw}
...
1. #### <i class="fa fa-music"></i> <i class="fa fa-icon fa-rotate-right"></i> Đọc thành tiếng {#anchor-langdu}
...
1. #### <i class="fa fa-copy"></i> <i class="fa fa-icon fa-rotate-right"></i> Sao chép vào khay nhớ tạm {#anchor-copy}
...
1. #### <i class="fa fa-history"></i> <i class="fa fa-icon fa-rotate-right"></i> Hiện/Ẩn lịch sử văn bản {#anchor-history}
...
1. #### <i class="fa fa-edit"></i> <i class="fa fa-icon fa-rotate-right"></i> Chỉnh sửa Lịch sử dịch thuật {#anchor-edittrans}
...
1. #### <i class="fab fa-windows"></i> <i class="btnstatus2 fab fa-windows"></i> Liên kết với Cửa sổ (Nhấn vào để hủy) {#anchor-bindwindow}
...
1. #### <i class="fa fa-neuter"></i> <i class="btnstatus2 fa fa-neuter"></i> Ghim cửa sổ trên cùng {#anchor-keepontop}
...
1. #### <i class="fa fa-refresh"></i> Đặt lại trạng thái dịch {#anchor-reset_TS_status}
