...
1. #### <i class="fa fa-compress"></i> <i class="fa fa-expand"></i> Масштабирование окна Полноэкранный режим масштабирования {#anchor-fullscreen}
    Позволяет одним кликом масштабировать игровое окно с помощью встроенного Magpie.

1. #### <i class="fa fa-compress"></i> <i class="fa fa-expand"></i> Масштабирование окна Режим масштабирования окна {#anchor-windowscaling}
    Позволяет одним кликом масштабировать игровое окно с помощью встроенного Magpie.
