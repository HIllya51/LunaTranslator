...
1. #### <i class="fa fa-gear"></i> <i class="fa fa-icon fa-rotate-right"></i> Открыть настройки {#anchor-setting}
    Пропущено
1. #### <i class="fa fa-file"></i> <i class="fa fa-icon fa-rotate-right"></i> Прочитать буфер обмена {#anchor-copy_once}
...
1. #### <i class="fa fa-mouse-pointer"></i> <i class="btnstatus2 fa fa-mouse-pointer"></i> Сквозное окно для мыши {#anchor-mousetransbutton}
...
1. #### <i class="fa fa-lightbulb"></i> <i class="btnstatus2 fa fa-lightbulb"></i> Прозрачность фонового окна {#anchor-backtransbutton}
...
1. #### <i class="fa fa-lock"></i> <i class="btnstatus2 fa fa-unlock"></i> Закрепить панель инструментов {#anchor-locktoolsbutton}
...
1. #### <i class="fa fa-link"></i> <i class="fa fa-icon fa-rotate-right"></i> Выбор игры {#anchor-selectgame}
    **Эта кнопка доступна только в режиме HOOK**

    Нажмите кнопку, чтобы открыть окно выбора процесса игры для подключения (HOOK).
1. #### <i class="fa fa-tasks"></i> <i class="fa fa-icon fa-rotate-right"></i> Выбор текста {#anchor-selecttext}
    **Эта кнопка доступна только в режиме HOOK**
...
1. #### <i class="fa fa-crop"></i> <i class="fa fa-icon fa-rotate-right"></i> Выбор области OCR {#anchor-selectocrrange}
...
1. #### <i class="fa fa-square"></i> <i class="fa fa-icon fa-rotate-right"></i> Показать/скрыть рамку области {#anchor-hideocrrange}
    **Эта кнопка доступна только в режиме OCR**
...
1. #### <i class="fa fa-crop"></i> <i class="fa fa-icon fa-rotate-right"></i> Выполнить OCR один раз {#anchor-ocr_once}
...
1. #### <i class="fa fa-book"></i> <i class="fa fa-icon fa-rotate-right"></i> Перевод собственных имён: замена перед переводом {#anchor-noundict_direct}
1. #### <i class="fa fa-book"></i> <i class="fa fa-icon fa-rotate-right"></i> Перевод собственных имён {#anchor-noundict}
1. #### <i class="fa fa-won"></i> <i class="fa fa-icon fa-rotate-right"></i> Корректировка перевода {#anchor-fix}
...
1. #### <i class="fa fa-times"></i> <i class="fa fa-icon fa-rotate-right"></i> Выход {#anchor-quit}
    Пропущено
1. #### <i class="fa fa-hand-paper"></i> <i class="fa fa-icon fa-rotate-right"></i> Перемещение {#anchor-move}
...
1. #### <i class="fa fa-volume-off"></i> <i class="btnstatus2 fa fa-volume-up"></i> Без звука в игре {#anchor-muteprocess}
...
1. #### <i class="fa fa-music"></i> <i class="fa fa-icon fa-rotate-right"></i> Озвучить {#anchor-langdu}
...
1. #### <i class="fa fa-rotate-left"></i> <i class="fa fa-icon fa-rotate-right"></i> Показать/скрыть историю текстов {#anchor-history}
...
1. #### <i class="fa fa-edit"></i> <i class="fa fa-icon fa-rotate-right"></i> Редактирование {#anchor-edit}
...
1. #### <i class="fa fa-edit"></i> <i class="fa fa-icon fa-rotate-right"></i> Редактировать историю переводов {#anchor-edittrans}
    Открыть окно редактирования истории переводов текущей игры.
1. #### <i class="fa fa-download"></i> <i class="fa fa-icon fa-rotate-right"></i> Имитация нажатия Ctrl {#anchor-simulate_key_ctrl}
1. #### <i class="fa fa-download"></i> <i class="fa fa-icon fa-rotate-right"></i> Имитация нажатия Enter {#anchor-simulate_key_enter}
...
1. #### <i class="fab fa-windows"></i> <i class="btnstatus2 fab fa-windows"></i> Привязать окно (нажмите для отмены) {#anchor-bindwindow}
...
1. #### <i class="fa fa-neuter"></i> <i class="btnstatus2 fa fa-neuter"></i> Поверх других окон {#anchor-keepontop}
    Отменить/установить окно перевода поверх других

1. #### <i class="fa fa-i-cursor"></i> <i class="btnstatus2 fa fa-i-cursor"></i> Выделяемый текст {#anchor-selectable}
...
1. #### <i class="fa fa-search"></i> <i class="fa fa-icon fa-rotate-right"></i> Поиск слова {#anchor-searchwordW}
