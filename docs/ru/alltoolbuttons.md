...
1. #### <i class="fa fa-lightbulb"></i> <i class="btnstatus2 fa fa-lightbulb"></i> Прозрачный фон окна {#anchor-backtransbutton}
...
1. #### <i class="fa fa-compress"></i> <i class="fa fa-expand"></i> Масштабирование окна {#anchor-fullscreen}
    ...
    По умолчанию левый клик — оконное масштабирование, правый клик — полноэкранное масштабирование. Функции левого и правого клика можно поменять местами в настройках.
...
1. #### <i class="fa fa-history"></i> <i class="fa fa-icon fa-rotate-right"></i> Показать/скрыть историю текста {#anchor-history}
