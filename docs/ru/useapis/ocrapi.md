...
В разделе `Загрузка ресурсов` также представлены высокоточные модели для китайского, японского и английского языков, которые могут обеспечить чрезвычайно высокую точность распознавания, однако скорость распознавания относительно низкая.
