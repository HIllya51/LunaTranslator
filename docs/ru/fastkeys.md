...
1. #### Сквозное кликание окна {#anchor-_8}
...
1. #### Закрепить панель инструментов {#anchor-_9}
...
1. #### Перевод выделенного текста {#anchor-38}
...
1. #### Выбор области OCR {#anchor-_13}
...
1. #### Показать/скрыть рамку области {#anchor-_14}
    **Доступно только в режиме OCR**
...
1. #### Очистить область OCR {#anchor-_14_1}
    **Доступно только в режиме OCR**
...
1. #### Чтение буфера обмена {#anchor-36}
...
1. #### Автоматическое озвучивание {#anchor-_32}
    Переключить автоматическое озвучивание.

1. #### Озвучивание {#anchor-_7}
...
1. #### Прервать озвучивание {#anchor-_7_1}
    Прервать текущее озвучивание.

## Игры

1. #### Привязать окно (нажмите для отмены) {#anchor-_15}
...
1. #### Беззвучный режим игры {#anchor-_22}
    После привязки игрового окна (не только в режиме hook, но и в режимах OCR или буфера обмена - главное, чтобы окно было привязано), можно одним кликом отключить звук в игре, избавившись от необходимости делать это через микшер громкости системы.

1. #### Масштабирование Magpie {#anchor-41}
    Одним нажатием можно применить встроенное масштабирование Magpie для игрового окна в полноэкранном режиме.

1. #### Оконное масштабирование Magpie {#anchor-42}
    Одним нажатием можно применить встроенное оконное масштабирование Magpie для игрового окна.

## Поиск слов

1. #### Поиск выделенного слова {#anchor-37}
...
1. #### Anki запись примеров {#anchor-_30}
...
1. #### Anki добавление {#anchor-_35}
    Добавить слово в Anki

1. #### Произношение слова {#anchor-_33}
