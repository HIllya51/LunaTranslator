...
1. #### 이력 텍스트 표시/숨기기 {#anchor-_6}
    이력 텍스트 창을 열거나 닫습니다.

1. #### 마우스 클릭 스루 창 {#anchor-_8}
...
1. #### 게임 음소거 {#anchor-_22}
    게임 창을 바인딩한 후 (HOOK 모드뿐만 아니라 OCR 또는 클립보드 모드도 가능하며, 게임 창이 바인딩되기만 하면 됨), 한 번의 클릭으로 게임을 음소거할 수 있어 시스템 볼륨 믹서에서 게임을 음소거하는 번거로움을 덜 수 있습니다.

1. #### Magpie 확대 {#anchor-41}
    한 번의 클릭으로 게임 창에 내장된 Magpie를 사용해 전체 화면 확대를 적용할 수 있습니다.

1. #### Magpie 창 모드 확대 {#anchor-42}
    한 번의 클릭으로 게임 창에 내장된 Magpie를 사용해 창 모드 확대를 적용할 수 있습니다.

## 단어 검색

1. #### 단어 추출 검색 {#anchor-37}
