...
1. #### 유니코드 정규화 {#anchor-fulltohalf}

    자세한 내용: [https://ko.wikipedia.org/wiki/유니코드_등가성](https://ko.wikipedia.org/wiki/%EC%AF%B0%EB%8B%88%EC%BD%94%EB%93%9C_%EB%93%B1%EA%B0%80%EC%84%B1)

    예: `？？？（Ｉ ｇｕｅｓｓ ｈｅ ｄｏｅｓｎ’ｔ ｗａｎｔ ｔｏ ｔａｌｋ ｔｏ ｓｔｒａｎｇｅｒｓ．．．）`는 다음과 같이 변환됩니다: `???(I guess he doesn’t want to talk to strangers...)`
