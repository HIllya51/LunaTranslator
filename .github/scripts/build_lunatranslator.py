...
if __name__ == "__main__":
    ...
    if sys.argv[1] == "cpp":
        ...
        if arch == "xp":
            ...
            shutil.copy("cpp/builds/_x86/shareddllproxy32.exe", "cpp/builds/files/plugins")
            shutil.copy(
                "cpp/builds/_x86/winsharedutils.dll", "cpp/builds/files/plugins/DLL32"
            )
            os.chdir(rootDir)
        ...
        shutil.copy("cpp/builds/_x86/shareddllproxy32.exe", "cpp/builds/files/plugins")
        shutil.copy("cpp/builds/_x86/winrtutils.dll", "cpp/builds/files/plugins/DLL32")
        shutil.copy("cpp/builds/_x86/winsharedutils.dll", "cpp/builds/files/plugins/DLL32")
        shutil.copy("cpp/builds/_x86/wcocr.dll", "cpp/builds/files/plugins/DLL32")
        shutil.copy("cpp/builds/_x86/LunaOCR.dll", "cpp/builds/files/plugins/DLL32")
        os.makedirs("cpp/builds/files/plugins/DLL64", exist_ok=True)
        shutil.copy("cpp/builds/_x64/shareddllproxy64.exe", "cpp/builds/files/plugins")
        shutil.copy("cpp/builds/_x64/winrtutils.dll", "cpp/builds/files/plugins/DLL64")
        shutil.copy("cpp/builds/_x64/winsharedutils.dll", "cpp/builds/files/plugins/DLL64")
        shutil.copy("cpp/builds/_x64/wcocr.dll", "cpp/builds/files/plugins/DLL64")
        shutil.copy("cpp/builds/_x64/LunaOCR.dll", "cpp/builds/files/plugins/DLL64")
